...
namespace MVVMDataBinding
{
    ...
    public class CashRegisterModelView : INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// Gets or sets the number of $1 in the cash register
        /// </summary>
        public int Ones
        {
            get => drawer.Ones;
        ...
        /// <summary>
        /// Gets or sets the number of $2 in the cash register
        /// </summary>
        public int Twos
        {
            get => drawer.Twos;
        ...
        /// <summary>
        /// Gets or sets the number of $5 in the cash register
        /// </summary>
        public int Fives
        {
            get => drawer.Fives;
        ...
        /// <summary>
        /// Gets or sets the number of $10 in the cash register
        /// </summary>
        public int Tens
        {
            get => drawer.Tens;
        ...
        /// <summary>
        /// Gets or sets the number of $20 in the cash register
        /// </summary>
        public int Twnties
        {
            get => drawer.Twenties;
        ...
        /// <summary>
        /// Gets or sets the number of $50 in the cash register
        /// </summary>
        public int Fifties
        {
            get => drawer.Fifties;
        ...
        /// <summary>
        /// Gets or sets the number of $100 in the cash register
        /// </summary>
        public int Hundreds
        {
            get => drawer.Hundreds;
